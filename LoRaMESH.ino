...
void loop() {
  if(count % 250 == 0)//  30 : Se o contador que é incrementado no timer chegar a 30 segundos (120ms * 250=30) ... envia um comando para um escravo. o comando será RSSI, depois Leitura da porta analógica 5 e por últio
  {
        ...
        if((comandos%4) ==0)// %3 porque são 3 comandos diferente para cada EndDevice / Radio. Podem ser incluídos novos comandos. o Primeiro é a medida de nível de sinal de recepção
        {
        ...
        else if((comandos%4) == 1) // %3 porque são 3 comandos diferente para cada EndDevice / Radio. Podem ser incluídos novos comandos 
        {
        ...
        else if((comandos%4) == 2) //podem ser incluídos novos comandos 
        {
        ...
        else if((comandos%4) == 3) //podem ser incluídos novos comandos 
        {
         CMD_aplicacao(listaEndDevices[polingID%5], c_cmd_app, s_msg);
          polingID++;//Enviou os 3 comandos diferentes para um ID... então ... vai para o próximo ID/Rádio/EndDevice
        }
